...
public class Pattern_Alphabet {
    public static void main(String[] args) {
        ...
        for(int i=1; i<=num;i++){
            for (int j=1;j<=num;j++){
                if(i==1||i==num||j==1||(j==num&&i>=m)||(i==m&&j>=m))
                    System.out.print("* ");
                    else
                    System.out.print("  ");
            }
        ...
        for(int i=1; i<=num;i++){
            for (int j=1;j<=num;j++){
                if(i==1||i==4||j==num||(i==j&&i>=m)||(j==1&&i!=num))
                    System.out.print("* ");
                    else
                    System.out.print("  ");
            }
